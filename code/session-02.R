...
my_df = read.csv("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/data_intro_r.csv",
                 sep = ",")
...
# load data including working directory
library(rio)
my_df_import = import("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/data_intro_r.csv")
...
library(readr)
my_df_readr = read_csv("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/data_intro_r.csv")
...
library(readxl)
my_excel = read_excel("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/r_intro.xlsx")
...
# name of the sheet 
library(readxl)
my_excel = read_excel("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/r_intro.xlsx", sheet = "thisisaverylongnameforasheet")
...
# name of the sheet 
library(readxl)
my_excel = read_excel("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/r_intro.xlsx", sheet = 1)
...
# rows
library(readxl)
my_excel_clean = read_excel("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/r_intro.xlsx", sheet = 1, cell_rows(10:15))
...
my_excel_clean_cols = read_excel("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/r_intro.xlsx", sheet = 1, cell_cols("C:L"))
...
# range
my_excel_clean_range = read_excel("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/r_intro.xlsx", sheet = 1, range = "A11:M337")
...
my_excel_2011= read_excel("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/r_intro.xlsx", sheet = 1, range = c("E11:H327"))
...
library(readr)
my_data = read_csv("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/data_intro_r.csv")
...
my_data = import("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/data_intro_r.csv")
...
d1  = import("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/pop_link.csv")

d2 = import("/Users/Personas/Dropbox/PhD/teaching/applied_eco_r/session-02/data/raw/claim_link.csv")
